                ...
                <ScrollView >
                    <View style={{ backgroundColor: Colors.divider, flex: 1, padding: 20 }}>
                        ...
                        <View style={{ marginBottom: 10, flexDirection: 'column', width: '100%' }}>
                            ...
                            <TouchableOpacity style={{ flexDirection: 'row', borderRadius: 10, elevation: 5, backgroundColor: Colors.TheamColor, alignItems: 'center', padding: 5, paddingHorizontal: 10, marginTop:10 }} onPress={() => selectDocs()}>
