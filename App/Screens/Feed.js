                ...
                userArray.length === 0 && LocalData.FLAG !== '1' ?
                    ...
                    <View style={{ flexDirection: 'column', flex: 1 }}>
                        ...
                        {/* <View style={{ flexDirection: 'row' }}>
                            <View style={[{ marginHorizontal: 8, flex: 1, height: 40, marginVertical: 3, marginTop: 8, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 10, borderRadius: 4, backgroundColor: isToday ? Colors.TheamColor3 : Colors.gray }]}>
                                <TouchableOpacity style={{ width: '100%' }} onPress={() => ToggleToday()}>
                                    <Text style={[Style.text14, { textAlign: 'center', width: '100%', color: Colors.white }]}>Today</Text>
                                </TouchableOpacity>
                            </View>
                            <View style={[{ marginHorizontal: 8, flex: 1, height: 40, marginVertical: 3, marginTop: 8, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 10, borderRadius: 4, backgroundColor: isAll ? Colors.TheamColor3 : Colors.gray }]}>
                                <TouchableOpacity style={{ width: '100%' }} onPress={() => ToggleAll()}>
                                    <Text style={[Style.text14, { textAlign: 'center', width: '100%', color: Colors.white }]}>All</Text>
                                </TouchableOpacity>
                            </View>
                        </View> */}
                        <FlatList
